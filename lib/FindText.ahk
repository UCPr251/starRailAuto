  ...
  Gui(cmd, arg1 := "", args*)
  {
    ...
    Switch cmd, 1
    {
      ...
      Case "MakeMainWindow":
        ...
        _Gui.Add("Text", "x+0 w80", 35)
        id := _Gui.Add("UpDown", "vMyhh Range1-100", 35)
        id.GetPos(&pX, &pY, &pW, &pH)
...
GetRange   = 屏幕范围 = 获取屏幕范围到剪贴板并替换代码中的范围参数
GetOffset  = 相对坐标 = 获取相对图像位置的偏移坐标并替换代码中的点击坐标
GetClipOffset  = 相对坐标2 = 获取相对左边编辑框的图像的偏移坐标
Capture    = 抓图 = 开始屏幕抓图
